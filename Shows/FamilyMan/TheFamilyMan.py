...
# IMDb Ratings
ratings = [8.3, 8.4, 8.4, 8.7, 8.3, 9.1, 8.6, 8.8, 8.6, 7.8]
# Subtitle Files
files = ["E1S1.srt", "E2S1.srt", "E3S1.srt", "E4S1.srt", "E5S1.srt", "E6S1.srt", "E7S1.srt", "E8S1.srt", "E9S1.srt", "E10S1.srt"]
...
# print(ls)
# print(count)
# 204 curse words total.
c = Counter(count_dict)
print(c.most_common(10))
corr, _ = pearsonr(count_time_, ratings)
print('Pearsons correlation: %.3f' % corr)
# Pearsons Correlation 0.185 between curse count and IMDb Rating.
...
def graph():
    ...
    ax3 = ax1.twinx()
    plt.title('The Family Man', **cs_font, fontweight='bold')
    ...
    x_values = [4.6, 4.8, 5, 5.2, 5.4, 5.6, 5.8, 6]
    y_values = [13, 14, 21, 54, 24, 33, 14, 17]
    ax3.bar(x_values, y_values, alpha=0.2)
    ax3.set_yticks([])
    # Most used word was Fuck.
    ax1.text(4.95, 25.75, 'Fuck', fontname='sans-serif', fontweight='light',fontsize=9)
    # Change limits of bar chart to make it fit better.
    ax3.set_ylim(0, 80)
    plt.savefig('TheFamilyMan.png', dpi=300, bb0x_inches='tight')
    plt.show()
