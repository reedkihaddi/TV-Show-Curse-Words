...
trivedi = []
# IMDb Ratings
ratings = [8.8, 8.3, 8.2, 8.3, 8.3, 8.7, 8.8, 8.9]
# Subtitle Files
files = ["E1S1.srt", "E2S1.srt", "E3S1.srt", "E4S1.srt", "E5S1.srt", "E6S1.srt", "E7S1.srt", "E8S1.srt"]
...
def graph():
    ...
    ax1.legend(loc='upper left',frameon=False,shadow=True)
    ax3 = ax1.twinx()
    plt.title('Sacred Games (Season 1)',**cs_font, fontweight='bold')
    ...
    ax1.text(4.0, 41, 'Fuck', fontname='sans-serif', fontweight='normal')
    # Change limits of bar chart to make it fit better.
    ax3.set_ylim(0, 80)
    plt.savefig('SacredGamesS01.png',dpi=300,bb0x_inches='tight')
    plt.show()
